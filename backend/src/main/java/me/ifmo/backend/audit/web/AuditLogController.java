...
@Tag(name = "Audit Logs", description = "Administrative access to recorded system activity")
public class AuditLogController {
    ...
    public PageResponse<AuditLogResponse> search(@Valid @ModelAttribute AuditLogSearchRequest request, @ParameterObject Pageable pageable) {
